...
export const ETLDashboard = () => {
  ...
  const handleOnStart = async () => {
    ...
    for (const element of streamNamesArray) {
      ...
      const result = await fetch(
        `https://api-anurag.eng.macrometa.io/_fabric/_system/_api/streamapps/${element}/active?active=true`,
        {
          method: "PATCH",
          headers: {
            Authorization:
  ...
  const handleOnStop = async () => {
    ...
    for (const element of streamNamesArray.reverse()) {
      ...
      const result = await fetch(
        `https://api-anurag.eng.macrometa.io/_fabric/_system/_api/streamapps/${element}/active?active=false`,
        {
          method: "PATCH",
          headers: {
            Authorization:
